...
class Pogger():
    ...
    1.
        Any console output run after the instance is created is automatically
        saved to a log file.
    2.
        One can wrap any function using the `Pogger.record` decorator.
        The outputs of wrapped functions will be automatically saved to an hdf5
        file.
    3.
        Any figures generated in `matplotlib.pyplot` of wrapped functions will
    ...
    def record(self, result_names=None, result_units=None):
        ...
        1.
            Any return values of the function will be saved to an hdf5 archive,
            and,
        2.
            Any plots generated by `matplotlib.pyplot` will be saved to disk.
